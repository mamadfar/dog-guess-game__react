...
interface IQuestionsProps extends Omit<IInitialState, "highScore" | "bigCollection" | "fetchCount"> {
    points: number;
    strikes: number;
...
const Questions:FC<IQuestionsProps> = ({playing, points, strikes, timeRemaining, currentQuestion, guessHandler}) => {
  return (
    <>
